...
/** /bolgelerimiz sayfasinin dil degistirmeye bagli client kismi. children footer'dan once yer alir. */
export default function RoutesPageContent({ children }: { children?: React.ReactNode }) {
  ...
  const getTexts = () => {
    switch(lang) {
      ...
      default: return { sub: 'Popüler Rotalar', title: 'Lüks Destinasyonlar & Marinalar' };
    }
  };
