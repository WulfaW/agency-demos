...
export default function StickyScrollExperience() {
  ...
  const getSteps = () => {
    switch(lang) {
      ...
      case 'RU': return [
        { number: "01", tag: "АЭРОПОРТ & JET ТЕРМИНАЛ", title: "Персональная Встреча", desc: "Ваш водитель встретит вас с табличкой на выходе из терминала аэропорта (BJV).", highlights: ["Отслеживание Рейса", "Бесплатное Ожидание", "Поддержка VIP-Терминала"], image: "/images/route.jpg", accent: "BJV → Yalıkavak" },
        { number: "02", tag: "ПЕРВЫЙ КЛАСС", title: "Комфорт в Кабине", desc: "Путешествуйте в комфорте: шумоизолированная кабина, потолок со звёздами, широкие кожаные сиденья и прохладные напитки.", highlights: ["Звёздный Потолок", "Напитки & Wi-Fi", "Шумоизоляция"], image: "/images/inside.jpg", accent: "Mercedes Maybach" },
      ...
      case 'DE': return [
        { number: "01", tag: "FLUGHAFEN", title: "Persönliche Begrüßung", desc: "Ihr Chauffeur begrüßt Sie mit einem Namensschild am Ausgang des Flughafens (BJV).", highlights: ["Flugverfolgung", "Kostenlose Wartezeit", "VIP-Terminal-Support"], image: "/images/route.jpg", accent: "BJV → Yalıkavak" },
        { number: "02", tag: "FIRST CLASS", title: "Komfort", desc: "Reisen Sie bequem mit schalldichter Kabine, Sternenhimmel, breiten Ledersitzen und kalten Getränken.", highlights: ["Sternenhimmel", "Minibar & Wi-Fi", "Schalldicht"], image: "/images/inside.jpg", accent: "Mercedes Maybach" },
      ...
      case 'AR': return [
        { number: "01", tag: "المطار وصالة الطائرات", title: "استقبال شخصي", desc: "سيستقبلك سائقك بلافتة باسمك عند مخرج المطار.", highlights: ["تتبع الرحلة", "انتظار مجاني", "دعم صالة VIP الخاصة"], image: "/images/route.jpg", accent: "BJV → Yalıkavak" },
        { number: "02", tag: "درجة أولى", title: "راحة الكابينة الخاصة", desc: "سافر بكل راحة في كابينة خاصة معزولة صوتياً مع سقف نجمي ومقاعد جلدية فاخرة ومشروبات باردة.", highlights: ["سقف النجوم الفاخر", "بار بارد & واي فاي", "عزل صوتي"], image: "/images/inside.jpg", accent: "Mercedes Maybach" },
